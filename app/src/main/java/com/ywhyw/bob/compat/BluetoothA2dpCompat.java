...
public class BluetoothA2dpCompat {
    static interface BluetoothA2dpVersionImpl {
        ...
        public List<BluetoothDevice> getDevicesMatchingConnectionStates(Object receiver,
                int[] states);
    ...
    static class BluetoothA2dpStubImpl implements BluetoothA2dpVersionImpl {
        @Override public boolean obtain(Context context, BluetoothA2dpStubCallback callback) {
            return false;
        }
        ...
        @Override public List<BluetoothDevice> getDevicesMatchingConnectionStates(Object receiver,
                int[] states) {
            return null;
        }
    ...
    public static boolean obtain(Context context, final BluetoothA2dpCompatCallback callback) {
        ...
        final BluetoothA2dpStubCallback stubCallback = new BluetoothA2dpStubCallback() {
            ...
            @Override public void onProxyConnected(Object receiver) {
    ...
    interface BluetoothA2dpStubCallback {
         void onProxyConnected(Object receiver);

         void onProxyDisconnected();
    }

    public interface BluetoothA2dpCompatCallback {
         void onProxyConnected(BluetoothA2dpCompat proxy);
